...
public class SquishContactInteractable : BaseContactInteractables
{
    ...
    void Start(){
        ...
        passableObjectsLayerMask = (1 << LayerMask.NameToLayer("onewayplatform")) | (1 << LayerMask.NameToLayer("plant")) | (1 << LayerMask.NameToLayer("collectible")) | (1 << LayerMask.NameToLayer("switch")) | (1<<2);
    }
